...
typedef struct
{
    void (*get_all_capabilities) (bdaddr_t addr);
    void (*discover) (bdaddr_t addr);
    void (*reconfigure) (bdaddr_t addr);
    void (*start_streaming) (bdaddr_t addr);
    void (*close_streaming) (bdaddr_t addr);
    void (*suspend_streaming) (bdaddr_t addr);
    void (*abort_streaming) (bdaddr_t addr);
} btavdtp_pts_interface_t;
