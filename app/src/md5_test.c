 ...
 */
void
HASH_MD5Init (HASH_MD5_CTX *mdContext)
{
 ...
 */
void
HASH_MD5Update(HASH_MD5_CTX *mdContext, UINT8 *inBuf, UINT16 inLen)
{
  UINT32 in[16];
  INT16 mdi;
  UINT16 i, ii;
  ...
  mdi = (INT16)((mdContext->i[0] >> 3) & 0x3F);
 ...
 */
void
HASH_MD5Final (UINT8 hash[], HASH_MD5_CTX *mdContext)
{
  UINT32 in[16];
  INT16 mdi;
  UINT16 i, ii;
 ...
 */
static void
Transform (UINT32 *buf, UINT32 *in)
{
