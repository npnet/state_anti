...
typedef struct
{
    ...
    UINT8 (*bond_request_handle_cb)(const bdaddr_t* const address, UINT32 value);
} bt_callbacks_t;
...
typedef struct
{
    int (*init) (const bt_callbacks_t *bt_callbacks, const bt_config_t *bt_config, bt_storage_t *bt_storage); /**< Bt initialization function */
    int (*enable) (void);                                                                                                                       /**< Bt enable function */
    int (*disable) (void);                                                                                                                       /**< Bt disable function */
    int (*cleanup) (void);                   															     /**< Bt cleanup function */
    const void *(*get_profile_interface) (const char *profile_id);									     /**< Bt get profile interface function */
    int (*set_osi_callbacks) (void *args);														     /**< Bt set osi callback function */
    int (*set_property) (bt_property_t *property);                                                                                   /**< Bt set property function */
    int (*get_property) (bt_property_t *property);         										            /**< Bt get property function */
    void (*set_visible)(int is_visiable);                                                                                                    /**< Bt set visible function */
    UINT8 (*get_visable)(void);																	/**< Bt get visible function */
    UINT8 (*get_enable_state)(void);																/**< Bt get enable state function */
    int (*inquiry) (UINT8 max_result, UINT8 is_liac);													/**< Bt inquiry function */
    void (*inquiry_cancel)(void);
    void (*buffer_free)(hci_data_t *data);															/**< Bt free buffer function */
